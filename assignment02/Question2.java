...
public class Question2
{
	...
	public static int[] makeRowMajor(int[][] array)
	{
		...
		if (array[0] == null) throw new IllegalArgumentException("Null First Row");

		int numCols = array[0].length;

		for (int i = 1; i < array.length; i++)
		{
			if (array[i] == null) throw new IllegalArgumentException("Null Row" + i);
			if (array[i].length != numCols) throw new IllegalArgumentException("Array is Ragged");
		}
	...
	{
		if (array == null) throw new IllegalArgumentException("Null Array");
		if (array.length < 2) throw new IllegalArgumentException("Illegal Array");

		int numRows = array[0];
		int numCols = array[1];

		if (array.length < 2 + numRows * numCols) throw new IllegalArgumentException("illegal array");
